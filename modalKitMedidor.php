...
<div class="modal fade bd-example-modal-lg" id="kitMedidor" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div id="uniformes">
                    <h4 style="margin-left: 310px; margin-bottom: 50px;">Kit de medidas</h4>
                </div>
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-2 col-form-label" style="margin-left: 70px;">Kit medidas</label>
                <div class="col-sm-2">
