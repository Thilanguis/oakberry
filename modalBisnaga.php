...
<div class="modal fade bd-example-modal-lg" id="bisnaga" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div id="uniformes">
                    <h4 style="margin-left: 246px; margin-bottom: 50px;">Bisnaga de leite condensado</h4>
                </div>
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-2 col-form-label" style="margin-left: 70px;">Bisnaga</label>
                <div class="col-sm-2">
