...
<div class="modal fade bd-example-modal-lg" id="fatiadorDeBanana" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div id="uniformes">
                    <h4 style="margin-left: 283px; margin-bottom: 50px;">Fatiador de Banana</h4>
                </div>
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-2 col-form-label" style="margin-left: 70px;">Fatiador de banana</label>
                <div class="col-sm-2">
